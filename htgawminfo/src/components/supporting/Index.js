...
const Form = props => {
    return (
        <form>
            <h2>Supporting Characters, Occupations, Alignments, and Statuses</h2>
            <list>
                <li>
                    <ul>Meggy Travers: Medical Student, Positive Alignment, Alive</ul>
                    <ul>Lila Stangard: N/A, Positive Alignment, Deceased</ul>
                    ...
                    <ul>Sam Keating: Psychology Professor, Negative Alignment, Deceased</ul>
                </li>
            </list>
        </form>
    )
